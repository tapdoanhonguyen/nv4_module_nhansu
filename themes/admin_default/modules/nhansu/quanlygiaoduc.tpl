...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <div class="pull-right">
            ...
            <a href="{quanlygiaoduc_add}" data-toggle="tooltip" data-placement="top" title="{LANG.quanlygiaoduc_add}" class="btn btn-success btn-sm">
    ...
    <div class="well" id="tms_sea">
        <form action="{NV_BASE_ADMINURL}index.php" id="formsearch" method="get">
            ...
            <div class="row">
                <div class="col-xs-24 col-sm-12  col-md-12  col-lg-5">
                    <div class="form-group">
                        <div class="input-group" style="width:100%">
                            <span class="input-group-addon w100">
                                {LANG.status}
                ...
                <div class="col-xs-24 col-sm-12  col-md-12  col-lg-8">
                    <div class="form-group">
                        ...
                        placeholder="{LANG.name_quanlygiaoduc}" />
                    </div>
                </div>
        ...
        <table class="table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th class="w100 text-center" style="vertical-align: middle;">ID</th>
                    <th class="text-center" style="vertical-align: middle;">{LANG.name_quanlygiaoduc}</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center" style="vertical-align: middle;"> {VIEW.id} </td>
                    <td class="text-center" style="vertical-align: middle;"> {VIEW.name_quanlygiaoduc} </td>
...
<script type="text/javascript">
    function nv_change_status(id) {
        ...
        if (confirm(nv_is_change_act_confirm[0])) {
            ...
            $.post(script_name + '?' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=quanlygiaoduc&nocache=' + new Date().getTime(), 'change_status=1&id='+id, function(res) {
