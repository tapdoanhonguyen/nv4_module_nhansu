		...
		<div class="row match-height">
			<div class="col-lg-12 col-24">
				<div class="card">
					<div class="card-header">
						<h5 class="card-title">Số lượng nhân sự theo trình độ Ngoại ngữ - Tin học</h5>
					</div>
					<div class="card-body">
			...
			<div class="col-lg-12 col-24">
				<div class="card">
					...
					<div class="card-body">
						<div id="bieudo_trinhdochuyenmon" style="width: 100%; height: 400px;"></div>
					</div>
				</div>
			</div>
			<div class="col-lg-12 col-24">
...
<script type='text/javascript'>
	...
	function drawVisualization() {
		...
		var options = {
			...
			hAxis: {title: 'Trình độ ngoại ngữ'},
			seriesType: 'bars',
			series: {5: {type: 'line'}}
		};
